...
function formatTime(minutes, seconds) {
  const properlyMinutes = String(minutes).padStart(2, '0');
  const properlySeconds = String(seconds).padStart(2, '0');
  return `${properlyMinutes}:${properlySeconds}`;
}
